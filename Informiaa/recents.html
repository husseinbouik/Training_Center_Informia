            ...
            <div class="col-xl-10 col-xxl-9">
                <div class="card shadow">
                    <div class="card-header d-flex flex-wrap justify-content-center align-items-center justify-content-sm-between gap-3">
                        <h5 class="display-6 text-nowrap text-capitalize mb-0">Recents</h5>
                            ...
                            <table class="table table-striped table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-center">Evaluation</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <tr>
                                        <td class="text-truncate text-center" style="max-width: 200px;">Problem solving</td>
                                        <td class="text-truncate text-center" style="max-width: 200px;">11-05-2002</td>
                                        <td class="text-center">22-10-2092</td>
                                        <td class="text-center text-center">life</td>
