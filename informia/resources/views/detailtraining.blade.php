...
<body>
    ...
    <div class="container mt-5" style="padding-bottom: 45px;padding-top: 44px;">
        <div class="col" style="color: #858796;margin: 16px;margin-left: 0px;"><a style="text-decoration: none;" href="trainings.blade.php"><span class="fs-5 mt-5 mb-5" style="margin-bottom: 20px;color: rgb(133,135,150);"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24" fill="none">
